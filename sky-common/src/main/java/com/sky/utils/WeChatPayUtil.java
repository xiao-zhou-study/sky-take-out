...
public class WeChatPayUtil {
    ...
    private CloseableHttpClient getClient() {
        ...
        try {
            ...
            WechatPayHttpClientBuilder builder = WechatPayHttpClientBuilder
                    .create().withMerchant(weChatProperties.getMchid(),
    ...
    private String jsapi(String orderNum, BigDecimal total, String description, String openid)
        ...
        // 修改点：使用RoundingMode.HALF_UP替代BigDecimal.ROUND_HALF_UP
        amount.put("total",
                total.multiply(new BigDecimal(100)).setScale(2, RoundingMode.HALF_UP).intValue());
